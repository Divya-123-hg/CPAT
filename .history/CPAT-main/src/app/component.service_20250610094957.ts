...
export class ComponentService {
  ...
  getComponentsByStatus(selected: string, table: string): Observable<ComponentItem[]> {
    return this.http.get<ComponentItem[]>(`${this.apiUrl}/${selected}/${table}`);
  }
  ...
  getComponentsByText(searchText: string): Observable<ComponentItem[]> {
    return this.http.get<ComponentItem[]>(`${this.apiUrl}/searchText/searchText/${searchText}`);
  }
  ...
  getNotifications(name:string):Observable<any>{
    return this.http.get<ComponentItem[]>(`${this.apiUrl}/a/a/a/a/a/a/a/a/a/a/a/a/a/${name}`);
  }
 
  deleteNotification(id: number):Observable<any> {
    console.log(id);
    return this.http.post(`${this.apiUrl}/put/a/a/a/a/a/a/a/a/a/a/a/a/notification`,{id});
  }
