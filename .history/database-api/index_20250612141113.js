...
app.post('/api/components', async (req, res) => {
    ...
    try {
        ...
        const result1 = await pool.query(
            'INSERT INTO reviewer_table(id, name, description, url, status, created_by,reviewed_by, notification) SELECT id, name, description, url, status, created_by, reviewed_by, from components WHERE id = $1 returning *',
            [id]
        );
