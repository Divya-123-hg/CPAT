...
app.post('/api/components', async (req, res) => {
    ...
    try {
        ...
        const id = result.rows[0].id;
         const notify= 'Component ${id} uploaded by $';
...
app.get('/api/components/a/a/a/a/a/a/a/a/a/a/a/a/a/:name', async (req, res) => {
    ...
    try {
        console.log(name,'testinggyaustiqulkhq3oiluq3');
