    ...
    try {
        ...
        if (result3.rows[0].status === 'More Details Required') {
            ...
            const result4 = await pool.query(
                `UPDATE reviewer_table SET name = $1, description = $2, url = $3, status = $4, created_by = $5, approved_at=null, reviewed_at=$6, reviewer_status=$7, approver_status=$10 WHERE id = $6 returning *`, [name, description, url, 'Pending For Review', created_by, id, null, null, null, null]
            );
