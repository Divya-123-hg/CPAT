...
app.post('/api/components/id/id/id/id/id', async (req, res) => {
    ...
    try {
        ...
        const result = await pool.query(
            `UPDATE COMPONENTS SET name = $1, description = $2, url = $3, status = $4, created_by = $5, approved_by=$7, approved_at=$8, reviewed_at=$9, reviewed_by=$10, reviewer_status=$11, approver_status=$12, reviewer_descripyion WHERE id = $6`, [name, description, url, 'Pending For Review', created_by, id, null, null, null, null, null, null]
        );
